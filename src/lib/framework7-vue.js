...
(function (global, factory) {
    ...
    var StatusBar = {
        render: function () {
            ...
            return _c('div', {staticClass: "statusbar-overlay"})
        },
        staticRenderFns: [],
    };
    ...
    var Views = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "views", class: _vm.classObject}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
    ...
    var Pages = {
        ...
        methods: {
            ...
            onRouteChange: function (event) {
                ...
                var previousRoute = self.$route.router.findMatchingRoute(view.url) || {
                        route: {
                            path: '/',
                            pagePath: '/'
                        }
                    ...
                    if (typeof(pageComponent) === 'object') {
                        ...
                        if (self.isLoad) {
                            ...
                            pageComponent().then(result => {
                                self.$set(self.pages, id, {component: result});
                                view.allowPageChange = false;
    ...
    var Navbar = {
        render: function () {
            ...
            return _c('div', {
                ...
                class: _vm.classesObject,
                on: {
                    "navbar:beforeinit": _vm.onBeforeInit,
                    "navbar:init": _vm.onInit,
                    "navbar:reinit": _vm.onReinit,
                    "navbar:beforeremove": _vm.onBeforeRemove
                }
            }, [_vm._t("before-inner"), _vm._v(" "), _c('div', {staticClass: "navbar-inner"}, [(_vm.backLink) ? _c('f7-nav-left', {
                attrs: {
                    "back-link": _vm.backLink,
                    "sliding": _vm.sliding,
                    "back-link-href": _vm.backLinkUrl || _vm.backLinkHref
                }, on: {"back-click": _vm.onBackClick}
            }) : _vm._e(), _vm._v(" "), (_vm.title) ? _c('f7-nav-center', {
                attrs: {
                    "title": _vm.title,
                    "sliding": _vm.sliding
                }
            }) : _vm._e(), _vm._v(" "), _vm._t("default")], 2), _vm._v(" "), _vm._t("after-inner")], 2)
        },
        staticRenderFns: [],
        updated: function () {
            var self = this;
    ...
    var NavLeft = {
        render: function () {
            ...
            return _c('div', {
                staticClass: "left",
                class: {sliding: _vm.sliding}
            }, [(_vm.backLink) ? _c('f7-link', {
                class: {'icon-only': (_vm.backLink === true || _vm.backLink && _vm.$theme.material)},
                attrs: {
                    "href": _vm.backLinkUrl || _vm.backLinkHref || '#',
                    "back": "",
                    "icon": "icon-back",
                    "text": _vm.backLink !== true && !_vm.$theme.material ? _vm.backLink : undefined
                },
    ...
    var NavRight = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "right", class: {sliding: _vm.sliding}}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
            sliding: Boolean
    ...
    var Subnavbar = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "subnavbar", class: _vm.sliding ? 'sliding' : false}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
            sliding: Boolean
    ...
    var Toolbar = {
        render: function () {
            ...
            return _c('div', {
                staticClass: "toolbar",
                class: _vm.classesObject
            }, [_vm._t("before-inner"), _vm._v(" "), _c('div', {staticClass: "toolbar-inner"}, [_vm._t("default")], 2), _vm._v(" "), _vm._t("after-inner")], 2)
        },
        staticRenderFns: [],
        props: {
            bottom: Boolean,
    ...
    var CardContent = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "card-content"}, [(_vm.inner) ? _c('div', {staticClass: "card-content-inner"}, [_vm._t("default")], 2) : _vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
            inner: {
    ...
    var ContentBlock = {
        render: function () {
            ...
            return _c('div', {
                ...
                class: _vm.classesObject,
                on: {"tab:show": _vm.onTabShow, "tab:hide": _vm.onTabHide}
            }, [(_vm.inner) ? _c('div', {staticClass: "content-block-inner"}, [_vm._t("default")], 2) : _vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
            'inset': Boolean,
    ...
    var ContentBlockTitle = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "content-block-title"}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
    };
    ...
    var Badge = {
        render: function () {
            ...
            return _c('span', {
                staticClass: "badge",
                class: _vm.color ? 'color-' + _vm.color : ''
            }, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
    ...
    var Icon = {
        render: function () {
            ...
            }, [_vm._v(_vm._s(_vm.iconTextComputed)), _vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
            'color': String,
    ...
    var ListGroup = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "list-block-group"}, [_c('ul', [_vm._t("default")], 2)])
        },
        staticRenderFns: [],
        props: {
            'media-list': Boolean,
    ...
    var ListItem = {
        render: function (c) {
            ...
            itemContentEl = c('f7-list-item-content', {
                ...
                on: (self.link || self.accordionItem || self.smartSelect) ? {} : {
                    click: self.onClick,
        ...
        render: function (c) {
            ...
            if (self.media || self.checkbox || self.radio && self.$theme.material || slotsMediaStart.length || slotsMedia.length) {
                if (self.checkbox || self.radio && self.$theme.material) {
                    if (self.media) {
                        ...
                        mediaEl = c('div', {
                            'class': {'item-media': true},
                            domProps: {innerHTML: inputIconEl + (self.media ? self.media : '')}
                        });
                    }
                    else {
            ...
            if (self.subtitle) {
                subtitleEl = c('div', {
                    ...
                    domProps: {innerHTML: self.subtitle}
                }, [self.subtitle]);
            }
            if (self.text) {
            ...
            return c((self.checkbox || self.radio) ? 'label' : 'div', {
                ...
                'class': {'label-checkbox': self.checkbox, 'label-radio': self.radio},
                on: {click: self.onClick}
            }, [slotsContentStart, inputEl, mediaEl, innerEl, slotsContent]);
        },
        props: {
            'title': [String, Number],
            'text': [String, Number],
    ...
    var ListItemSwipeoutActions = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {class: 'swipeout-actions-' + _vm.sideComputed}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
            'left': Boolean,
    ...
    var ListLabel = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "list-block-label"}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
    };
    ...
    var Accordion = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "accordion-list"}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
    };
    ...
    var AccordionToggle = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "accordion-item-toggle"}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
    };
    ...
    var AccordionContent = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "accordion-item-content"}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
    };
    ...
    var ButtonsSegmented = {
        render: function () {
            ...
            return _c('div', {
                ...
                class: (_vm.colorComputed ? 'theme-' + _vm.colorComputed : '')
            }, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
    ...
    var GridRow = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "row", class: {'no-gutter': _vm.noGutter}}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
            'no-gutter': Boolean
    ...
    var GridCol = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {class: ('col-' + _vm.width) + (_vm.tabletWidth ? ' tablet-' + _vm.tabletWidth : '')}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
            'width': {
    ...
    var Preloader = {
        render: function () {
            ...
            return _c('span', {
                ...
                class: (_vm.color ? ('color-' + _vm.color + ' preloader-' + _vm.color) : ''),
                style: ({
                    'width': (_vm.sizeComputed ? _vm.sizeComputed + 'px' : ''),
                    'height': (_vm.sizeComputed ? _vm.sizeComputed + 'px' : '')
                })
            }, [(_vm.$theme.material) ? _c('span', {staticClass: "preloader-inner"}, [_c('span', {staticClass: "preloader-inner-gap"}), _vm._v(" "), _vm._m(0), _vm._v(" "), _vm._m(1)]) : _vm._e()])
        },
        staticRenderFns: [function () {
            var _vm = this;
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('span', {staticClass: "preloader-inner-left"}, [_c('span', {staticClass: "preloader-inner-half-circle"})])
        }, function () {
            var _vm = this;
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('span', {staticClass: "preloader-inner-right"}, [_c('span', {staticClass: "preloader-inner-half-circle"})])
        }],
        props: {
            'color': String,
            'size': [Number, String]
    ...
    var FormLabel = {
        render: function () {
            ...
            return _c('div', {
                ...
                class: {'label': !_vm.floating, 'floating-label': _vm.floating}
            }, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
                ...
                if (self.type === 'select') {
                    if (self.hasSelectModel) {
                        ...
                        inputEl = c('select', {
                            attrs: attrs,
                            on: on,
                            domProps: {value: self.valueComputed}
                        }, self.$slots.default);
                    }
                }
                ...
                if (self.$slots.default && self.$slots.default.length > 0 || !self.type) {
                    ...
                    if (self.type === 'switch') {
                        ...
                        inputEl = c('input', {
                            attrs: attrs,
                            on: on,
                            domProps: {value: self.valueComputed, checked: self.checkedComputed}
                        });
                    }
                }
            }
    ...
    var FormSwitch = {
        render: function () {
            ...
            return _c('label', {
                ...
                domProps: {"value": _vm.valueComputed, "checked": _vm.checkedComputed},
                on: {"input": _vm.onInput, "change": _vm.onChange}
            }), _vm._v(" "), _c('div', {staticClass: "checkbox"})])
        },
        staticRenderFns: [],
        props: {
            name: String,
    ...
    var FormRange = {
        render: function () {
            ...
            return _c('div', {
                ...
                on: {"input": _vm.onInput, "change": _vm.onChange, "click": _vm.onClick}
            })])
        },
        staticRenderFns: [],
        props: {
    ...
    var Chip = {
        render: function () {
            ...
            return _c('span', {
                staticClass: "chip",
                class: _vm.chipClassObject,
                on: {"click": _vm.onClick}
            }, [(_vm.media) ? _c('span', {
                staticClass: "chip-media",
                class: _vm.mediaClassObject,
                domProps: {"innerHTML": _vm._s(_vm.media)}
            }) : _vm._e(), _vm._v(" "), (_vm.text) ? _c('span', {
                staticClass: "chip-label",
                domProps: {"innerHTML": _vm._s(_vm.text)}
            }) : _vm._e(), _vm._v(" "), (_vm.deleteable) ? _c('a', {
    ...
    var Fab = {
        render: function () {
            ...
            return _c('a', {
                ...
                class: _vm.color ? 'color-' + _vm.color : false,
                attrs: {"href": "#"},
                on: {"click": _vm.onClick}
            }, [_vm._t("default")], 2)
        },
    ...
    var FabSpeedDial = {
        render: function () {
            ...
            return _c('div', {
                ...
                class: _vm.theme ? 'theme-' + _vm.theme : false
            }, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
    ...
    var SwiperSlide = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "swiper-slide"}, [(_vm.zoom) ? _c('div', {staticClass: "swiper-zoom-container"}, [_vm._t("default")], 2) : _vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
            'zoom': Boolean
    ...
    var Message = {
        render: function () {
            ...
            return _c('div', {
                class: _vm.classesObject,
                on: {"click": _vm.onClick}
            }, [_vm._v("\n  " + _vm._s(_vm.day) + " "), (_vm.time) ? _c('span', [_vm._v(_vm._s(_vm.time))]) : _vm._e(), _vm._v(" "), _vm._t("start"), _vm._v(" "), (_vm.name) ? _c('div', {
                staticClass: "message-name",
                on: {"click": _vm.onNameClick}
            }, [_vm._v(_vm._s(_vm.name))]) : _vm._e(), _vm._v(" "), _c('div', {
                staticClass: "message-text",
                on: {"click": _vm.onTextClick}
            }, [_vm._t("default", [_vm._v(_vm._s(_vm.text))]), _vm._v(" "), (_vm.date) ? _c('div', {staticClass: "message-date"}, [_vm._v(_vm._s(_vm.date))]) : _vm._e()], 2), _vm._v(" "), (_vm.avatar) ? _c('div', {
                staticClass: "message-avatar",
                style: ({'background-image': 'url(' + _vm.avatar + ')'}),
                on: {"click": _vm.onAvatarClick}
            }) : _vm._e(), _vm._v(" "), (_vm.label) ? _c('div', {staticClass: "message-label"}, [_vm._v(_vm._s(_vm.label))]) : _vm._e(), _vm._v(" "), _vm._t("end")], 2)
        },
        staticRenderFns: [],
        props: {
            text: String,
    ...
    var Messagebar = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "toolbar messagebar"}, [_vm._t("before-inner"), _vm._v(" "), _c('div', {staticClass: "toolbar-inner"}, [_vm._t("before-textarea"), _vm._v(" "), _c('textarea', {
                ref: "area",
                attrs: {
            ...
            }, [_vm._v(_vm._s(_vm.value))]), _vm._v(" "), _vm._t("after-textarea"), _vm._v(" "), (_vm.sendLink && _vm.sendLink.indexOf('<') >= 0) ? _c('f7-link', {
                domProps: {"innerHTML": _vm._s(_vm.sendLink)},
                on: {"click": _vm.onClick}
            }) : _c('f7-link', {on: {"click": _vm.onClick}}, [_vm._t("send-link", [_vm._v(_vm._s(_vm.sendLink))])], 2), _vm._v(" "), _vm._t("default")], 2), _vm._v(" "), _vm._t("after-inner")], 2)
        },
        staticRenderFns: [],
        beforeDestroy: function () {
    ...
    var Tab = {
        ...
        render: function (c) {
            ...
            return c('div', {
                ...
                [activeTab && activeTab.tabId === self.routeTabId ? c(activeTab.component, {
                    tag: 'component',
                    props: self.$route.params
                }) : self.$slots.default]
            );
        },
        methods: {
    ...
    var Popover = {
        render: function () {
            ...
            return _c('div', {
                staticClass: "popover",
                on: {
                    "popover:open": _vm.onOpen,
                    "popover:opened": _vm.onOpened,
                    "popover:close": _vm.onClose,
                    "popover:closed": _vm.onClosed
                }
            }, [_c('div', {staticClass: "popover-angle"}), _vm._v(" "), _c('div', {staticClass: "popover-content"}, [_vm._t("default")], 2)])
        },
        staticRenderFns: [],
        methods: {
            onOpen: function (event) {
    ...
    var Popup = {
        render: function () {
            ...
            return _c('div', {
                ...
                class: _vm.classesObject,
                on: {
                    "popup:open": _vm.onOpen,
                    "popup:opened": _vm.onOpened,
                    "popup:close": _vm.onClose,
                    "popup:closed": _vm.onClosed
                }
            }, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
    ...
    var LoginScreen = {
        render: function () {
            ...
            return _c('div', {
                ...
                class: _vm.classesObject,
                on: {
                    "loginscreen:open": _vm.onOpen,
                    "loginscreen:opened": _vm.onOpened,
                    "loginscreen:close": _vm.onClose,
                    "loginscreen:closed": _vm.onClosed
                }
            }, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
    ...
    var LoginScreenTitle = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "login-screen-title"}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
    };
    ...
    var Actions = {
        render: function () {
            ...
            return _c('div', {
                ...
                class: {'modal-in': _vm.opened},
                on: {
                    "actions:open": _vm.onOpen,
                    "actions:opened": _vm.onOpened,
                    "actions:close": _vm.onClose,
                    "actions:closed": _vm.onClosed
                }
            }, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
    ...
    var ActionsGroup = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "actions-modal-group"}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
    };
    ...
    var Timeline = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "timeline", class: _vm.classesObject}, [_vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
            'sides': Boolean,
        ...
        render: function (c) {
            ...
            if (self.day || self.month) {
                dateEl = c('div', {
                    ...
                    domProps: {innerHTML: [self.day, '<small>' + self.month + '</small>'].join(' ')}
                });
            }
            else {
    ...
    var TimelineYear = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "timeline-year"}, [(_vm.year || _vm.title) ? _c('div', {staticClass: "timeline-year-title"}, [_c('span', {domProps: {"innerHTML": _vm._s(_vm.year || _vm.title)}})]) : _vm._e(), _vm._v(" "), _vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
            year: [Number, String],
    ...
    var TimelineMonth = {
        render: function () {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', {staticClass: "timeline-month"}, [(_vm.month || _vm.title) ? _c('div', {staticClass: "timeline-month-title"}, [_c('span', {domProps: {"innerHTML": _vm._s(_vm.month || _vm.title)}})]) : _vm._e(), _vm._v(" "), _vm._t("default")], 2)
        },
        staticRenderFns: [],
        props: {
            month: [Number, String],
    ...
    Framework7Router.prototype.changeRoute = function changeRoute(url, view, options) {
        ...
        var getMainView = function () {
            return this$1.framework7.views && this$1.framework7.views.reduce(function (mainView, nextView) {
                    if (nextView.main) {
                        return nextView;
                    } else {
                        return mainView;
