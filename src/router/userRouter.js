...
export default [
  ...
  {path: '/user/coupon/list', component: loadbyUserViewName('NewCouponList')},
  {path: '/user/coupon/get', component: loadbyUserViewName('GetCoupon')},
  {path: '/user/aboutUs', component: loadbyUserViewName('AboutUs')},
  {path: '/user/agreement', component: loadbyUserViewName('Agreement')},
  {path: '/user/coupon/help', component: loadbyUserViewName('CouponHelp')}
]
