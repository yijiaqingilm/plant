<template>
    <f7-page @page:reinit="reinit">
        ...
        <f7-block inner class="goodsDetail" no-hairlines>
            ...
            <div class="content">
                <div class="info">
                    <div class="goods-name">{{goods.name}}<span class="icon_bao" v-if="goods.supportvalue"></span><span
                            class="icon_te" v-if="goods.isspecial"></span></div>
                    <div class="goods-msg" v-if="goods.supportvalue">
                        本商品参与30天保价，30天内于其他平台发现同品质同规格商品，售价低于本平台价格，可联系客服申请退差价
                    </div>
