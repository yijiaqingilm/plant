        ...
        <f7-block inner class="pay" no-hairlines>
            ...
            <div class="content" v-if="orderInfo!=null">
                ...
                <div class="order-info-group" @click="alertShipfee">
                    <div>配送费用<img src="../../assets/icon_issue.png" alt="" class="icon_issue"></div>
        ...
        <div slot="fixed" class="pay_fixed">
            <my-picker :show="showMask" v-if="orderInfo!=null" @closeModal="hideModal">
                ...
                <div class="picker-content">
                    ...
                    <div class="group" v-for="(type,index) in payTypes"
        ...
        methods: {
            ...
            goPay: function () {
                ...
                userApi.payment({
                    ...
                    Cache.set('cartcount', parseInt(Cache.get('cartcount')) - cartids.length);
