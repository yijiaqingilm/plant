...
var gardenerApi = {
  ...
  apply (user) {
    return common.postFileRequest('/maintenance/main/apply', user, {isManager: true})
  },
  ...
  accomplish: function (info) {
    return common.postRequest('/maintenance/main/item-accomplish', info, {isManager: true})
  },
