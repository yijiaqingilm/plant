...
var sellApi = {
     ...
     */
    apply(user) {
        return common.postFileRequest('/seller/apply', user);
    },
    /**
     * 预约列表接口
     * @return {*}
     ...
     */
    addClient(client) {
        return common.postRequest('/seller/client/add', client);
    },
    /**
     * 编辑拜访客户接口
     * @param client
    ...
    payment(order, agent_id) {
        return common.postRequest('/seller/order/payment', {...order, agent_id});
    },
    /**
     * 更新销售员信息
     * @param sell
     ...
     */
    cartConfirm(info) {
        return common.postRequest('/seller/cart/confirm', info);
    },
    /**
     * 优惠券接口
     * @param type
